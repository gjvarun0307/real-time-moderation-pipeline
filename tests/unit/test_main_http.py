...
from ingest.main import build_http_app
...
async def test_metrics_returns_prometheus_text_format():
    ...
    async with TestClient(TestServer(app)) as client:
        ...
        # a metric already registered elsewhere in the process should
        # show up in the exposition output
        assert "ingest_events_received_total" in body
